...
var ImagesDialog = {
	init : function(ed) {
        ...
        $('#filesForm').attr('action', ImagesDialog.getUrlConnector());
        $('#form1').attr('action', ImagesDialog.getUrlConnector());
	},

    getUrlConnector: function() {
        return tinyMCEPopup.getParam('images_url_connector');
    },
...
$(function(){
	...
	$.ajax({
		type: "POST",
		url: ImagesDialog.getUrlConnector(),
	...
	swfu = new SWFUpload({
        ...
        upload_url: ImagesDialog.getUrlConnector(),
		post_params: {
			//"PHPSESSID" : "NONE",
			"action" : "uploadfile"
		},
