...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Menu.tmpl_list'
        db.add_column('cms_menu', 'tmpl_list',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Menu.tmpl_list'
        db.delete_column('cms_menu', 'tmpl_list')
    ...
    models = {
        ...
        'menu.menu': {
            ...
            'tmpl_list': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
