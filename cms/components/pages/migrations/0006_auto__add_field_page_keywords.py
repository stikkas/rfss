...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cms_com_pages', 'keywords',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('cms_com_pages', 'keywords')
    ...
    models = {
        ...
        'pages.page': {
            ...
            'create_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 12, 0, 0)'}),
