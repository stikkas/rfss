...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cms_com_pages', 'name', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'Page.annotation'
        db.alter_column('cms_com_pages', 'annotation', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True))

    def backwards(self, orm):

        # Changing field 'Page.name'
        db.alter_column('cms_com_pages', 'name', self.gf('django.db.models.fields.CharField')(max_length=510))

        # Changing field 'Page.annotation'
        db.alter_column('cms_com_pages', 'annotation', self.gf('django.db.models.fields.TextField')(max_length=510, null=True))
